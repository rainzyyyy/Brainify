    ...
    return (
        <nav className='flex justify-between items-center border border-b-middleGrey bg-chineseBlack p-6'>
            ...
            <div className='flex items-center space-x-16 ml-auto'>
                <span className='text-xl text-middleGrey'>xuminghao_o</span>

                <Link href="#"> {/* TODO: link to a page */}
                    <Image src='/assets/profile-pictures/xu-minghao.png' alt="Profile picture" width={50} height={50} className='rounded-full mr-16' />
                </Link>
            </div>
        </nav>
    );
